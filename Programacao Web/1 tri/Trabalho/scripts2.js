function verificar() {
    ...
    if (formEtnia.value == 'informaretnia') {
    ...
    if (formUniaofederativa.value == 'informaruniao') {
        formUniaofederativa.style.background = VERMELHO
        alert("Informe sua união federativa!")
        retorno = false
    } else {
    ...
    if (formsexo.value == 'informarsexo') {
        formsexo.style.background = VERMELHO
        alert("Informe seu sexo!")
        retorno = false
    } else {
        formsexo.style.background = VERDE
    }
    if(retorno){
